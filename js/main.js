...
document.addEventListener("DOMContentLoaded", function () {
  if (typeof Swiper !== "undefined") {
    if (document.querySelector(".mil-hero-slider")) {
      new Swiper(".mil-hero-slider", {
        loop: true,
        pagination: {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.addEventListener("click", function (event) {
    ...
    if (menuBtn) {
      ...
      event.target.closest(".mil-menu-frame") &&
      !event.target.closest(".mil-menu-frame > *")
    ) {
  ...
  document.querySelectorAll(".mil-main-menu li a").forEach((link) => {
    link.addEventListener("click", function (event) {
      ...
      if (isValidHref(href)) {
        document.querySelector(".mil-menu-btn").classList.remove("mil-active");
        document
          .querySelector(".mil-menu-frame")
          .classList.remove("mil-active");
        document
          .querySelector(".mil-buttons-tp-frame")
          .classList.remove("mil-active");
        document
          .querySelector(".mil-top-panel-2")
          .classList.remove("mil-menu-open");
      } else {
  ...
  function isValidHref(href) {
    return (
      href && href.trim() !== "" && href.length > 1 && !/^#(\.|$)/.test(href)
    );
  }
  ...
  /* -------------------------------------------
    ...
    ------------------------------------------- */
  document
    .querySelectorAll(".mil-onepage-nav > li > a, .mil-scroll-to")
    .forEach((link) => {
      link.addEventListener("click", function (event) {
        event.preventDefault();
